...
cond_prob_spi3_stdyld = copula_main(yld_pivot=alfalfa_yld_ct_std_pivot1, spi_pivot=spi_fin_stct1)

write.csv(cond_prob_spi3_stdyld, "/home/uallxr001/clim_shock/r_cop_output/alfalfa_cond_prob_and_GOF_and_aic_spi_growper_R_1971_00.csv", row.names=FALSE)
